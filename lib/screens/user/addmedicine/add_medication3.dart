// ignore_for_file: library_private_types_in_public_api, non_constant_identifier_names, unused_element

import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:meds/components/controller_data.dart';
import 'package:meds/screens/user/addmedicine/add_medication4.dart';
...
class _AddMedication3State extends State<AddMedication3> {
  ...
  void goToSummaryPage() {
    if (selectedTimes.isEmpty) {
      ...
      // print(
      //     'Times in 12 Hour: ${_medicationTimes12HController.text}');
                ...
                title: TextField(
                  onTap: () {
                    ...
                    if (selectedTimes.isEmpty) {
                      ...
                      String lastPlus10 = formatTime(
                        TimeOfDay.fromDateTime(
                          DateTime.parse('1970-01-01 ${selectedTimes.last}:00')
                              .add(
